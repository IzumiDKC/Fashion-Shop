...
namespace FashionShopDemo.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            if (!_roleManager.RoleExistsAsync(Role.Role_Customer).GetAwaiter().GetResult())
            {
                ...
                _roleManager.CreateAsync(new IdentityRole(Role.Role_Manager)).GetAwaiter().GetResult();
            }
            Input = new()
            {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                   ...
                   /* await _userManager.AddToRoleAsync(user, Role.Role_Customer); gắn giá trị cho lúc tạo là khách luôn */ 
                ...
                //    SendMail.SendEmail(user.Email, "Confirm your email", $"Please confirm your account by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.", "");
